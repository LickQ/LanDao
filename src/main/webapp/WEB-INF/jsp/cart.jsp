		...
		<!-- 判断购物车中是否有商品 -->
			...
			<div class="container">
								...
								<tr class="warning">
									...
									<tr class="active">
										<td width="60" width="40%">
											...
											<img src="${product.productIcon}"width="70" height="60">
										</td>
										<td width="30%">
											<a target="_blank">${product.productName}</a>
										</td>
										<td width="20%">
										...
										<td width="15%">
											<span class="subtotal">￥${orderDTO1.orderAmount}</span>
										</td>
										<%--<td>--%>
											<%--&lt;%&ndash;<a href="javascript:;" onclick="delProFromCart('${entry.value.product.pid}')" class="delete">删除</a>&ndash;%&gt;--%>
										<%--</td>--%>
									</tr>
				...
				<div style="margin-right:130px;">
					...
					登录后确认是否享有优惠&nbsp;&nbsp;
				</em> 赠送积分: <em style="color:#ff6600;">${cart.total }</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${orderDTO1.orderAmount}元</strong>
					</div>
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						<%--<a href="javascript:;" onclick="clearCart()" id="clear" class="clear">清空购物车</a>--%>
						<a href="${pageContext.request.contextPath }/paid?orderId=${orderDTO1.orderId}">
