	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/register.action" method="post" style="margin-top: 5px;" >
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control"  name="userRname"
								placeholder="请输入姓名">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control"  id="userage" name="userAge" onblur="checkage()"
								placeholder="年龄">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="usertelephone" name="userTelephone" onblur="checktel()"
								placeholder="电话号">
						</div>
					</div>
					<%--<div class="form-group">--%>
...
<script>
  function checkName(){
   ...
   function checkpassword(){
	  var pasword=document.getElementById("userPassword");
  ...
  function checkage(){
   ...
   function checktel(){
	  var tel=document.getElementById("usertelephone");
	  if(!(/^\d+$/.test(tel.value))){
